  ...
  CURSOR cREPORTS IS
    ...
    WHERE
      ...
      AND FORM_TYPE IN ('9_agr','m3','asa-21','1-inf.rev','65-auto-22','5-ci-22','ei-78','anc_conj','29_agr','24_agr','munca2_22','14_agr','15_agr','6_nr',
                        '5-con_22','16_agr','asa-22','1-inov','4_agr','21_vinz','24_agr');
  ...
  LOOP
    ...
    WHERE
      F.DEN_SHORT IN (DECODE(vTYPEFORM,'9_agr','Nr.9-AGR','m3','M3','asa-22','ASA','1-inf.rev','1-Inf.rev','65-auto-22','65-auto','5-ci-22','5-CI','ei-78','EI 7 EI  8',
                             ...
                             '6_nr','Forma Nr.6','5-con_22','5-CON','16_agr','16-AGR','1-inov','Nr. 1-INOV','4_agr','Nr.4-AGR','24_agr','24-AGR','21_vinz','21-VINZ')) AND
    ...
    WHERE
      ...
      F.DEN_SHORT IN (DECODE(vTYPEFORM,'9_agr','Nr.9-AGR','m3','M3','asa-22','ASA','1-inf.rev','1-Inf.rev','65-auto-22','65-auto','5-ci-22','5-CI','ei-78','EI 7 EI  8',
                             'anc_conj','Ancheta de Conjuctura','29_agr','Nr.29-AGR','24_agr','24-AGR','munca2_22','MUNCA 2','14_agr','14-AGR','15_agr','15-AGR',
                             '6_nr','Forma Nr.6','5-con_22','5-CON','16_agr','16-AGR','1-inov','Nr. 1-INOV','4_agr','Nr.4-AGR','24_agr','24-AGR','21_vinz','21-VINZ'));
    ---------------------------------------------------------
    ...
    --                              RR.RIND,
        ...
        ELSE 
              ...
              (
                ...
                ORDER BY
                  R.RIND) RR ON (D.NR_ROW = CASE WHEN RR.FORM IN (39) THEN DECODE(RR.DEN_SHORT,'Cap.I','CAP1')||'_R'||RR.RIND 
                                                 ...
                                                 WHEN RR.FORM IN (26,33,43,45) THEN DECODE(RR.DEN_SHORT,'Cap.I','CAP1','Cap.I-a','CAP1A','Cap.II','CAP2','Cap.III','CAP3')||'_R'||RR.RIND
          ...
          IF(vFORM IN (33,43,45) AND vID_SCHEMA IN (2)) THEN --if form is Agriculture insert FILIAL 4-AGR, 24-AGR, 29-AGR
              FOR FILIAL_AGR IN cFILIAL_AGR
              LOOP
                vFILIAL_AGR := '/dec/DataSet/Data/CAP/CAP_R[@line='||FILIAL_AGR.FILIAL_NR||']/*';
                INSERT INTO DATA_ALL_FOR_VALIDATE(PERIOADA,FORM,FORM_VERS,CUIIO,CUIIO_VERS,ID_MD,DATA_REG,ID_USER,COL1,COL2,COL3,COL4,COL5,
                                                  T_XML_FORM_ID,CREATED_DATE,ID_SCHEMA)
                SELECT
                  vPERIOADA,
                  vFORM,
                ...
                INNER JOIN
                  (
                    ...
                    WHERE
                      ...
                      R.STATUT <> '3'
                    ORDER BY
                      R.RIND) RR ON (D.NR_ROW = CASE WHEN RR.FORM IN (26,33,43,45) THEN DECODE(RR.DEN_SHORT,'Cap.I','CAP1','Cap.I-a','CAP1A','Cap.II','CAP2','Cap.III','CAP3')||'_R'||RR.RIND
                                                ELSE REPLACE(UPPER(REPLACE((RR.DEN_SHORT),'TITLUL','TITLU')),'.','')||'_R'||RR.RIND END);
              END LOOP;
          END IF;
